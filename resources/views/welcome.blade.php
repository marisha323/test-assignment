...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('user.all')}}">Show more</a></li>
...
<form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label class="text-danger" for="inputEmail4">Name</label>
    ...
    <div class="form-group">
        <label class="text-danger" for="exampleInputPassword1">Password</label>
